...
public class FragmentInflatorFactory implements LayoutInflater.Factory {
    ...
    public FragmentInflatorFactory(LayoutInflater delegate, Object fragment) {
        ...
        Log.e("INFLATOR", "FragmentInflatorFactory");
    ...
    private static class FragmentClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Log.e("CLIIIIICKKCKCKCKC", "CLIIIIICKKCKCKCKC");
            ...
            if (mMethod == null) {
                ...
                try {
                    ...
                    throw new IllegalStateException(
                            "Cannot find public method " + mMethodName + "(View) on " + clazz + " for onClick");
                }
            }
